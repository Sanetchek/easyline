  ...
  var b = window.Slick || {};b = function () {
    function c(c, d) {
      var f,
          ...
          return a('<span data-role="none" tabindex="0" />').text(c + 1);
    ...
    var a = this;a.$slideTrack.find(".slick-active").find("a, input, button, select").attr({ tabindex: "0" });
    ...
    var b = this;b.$slides.add(b.$slideTrack.find(".slick-cloned")).attr({ tabindex: "-1" }).find("a, input, button, select").attr({ tabindex: "-1" }), b.$slideTrack.attr("role", "listbox"), b.$slides.not(b.$slideTrack.find(".slick-cloned")).each(function (c) {
      a(this).attr({ role: "option", "aria-describedby": "slick-slide" + b.instanceUid + c });
    }), null !== b.$dots && b.$dots.attr("role", "tablist").find("li").each(function (c) {
      a(this).attr({ role: "tab", tabindex: "0", id: "slick-slide" + b.instanceUid + c });
    }).first().end().find("button").end().closest("div").attr("role", "toolbar"), b.activateADA();
    ...
    var c,
        ...
        e,
        f,
        b = this;d = b.$slides.eq(a).addClass("slick-current"), b.options.centerMode === !0 ? (c = Math.floor(b.options.slidesToShow / 2), b.options.infinite === !0 && (a >= c && a <= b.slideCount - 1 - c ? b.$slides.slice(a - c, a + c + 1).addClass("slick-active") : (e = b.options.slidesToShow + a, d.slice(e - c + 1, e + c + 2).addClass("slick-active")), 0 === a ? d.eq(d.length - 1 - b.options.slidesToShow).addClass("slick-center") : a === b.slideCount - 1 && d.eq(b.options.slidesToShow).addClass("slick-center")), b.$slides.eq(a).addClass("slick-center")) : a >= 0 && a <= b.slideCount - b.options.slidesToShow ? b.$slides.slice(a, a + b.options.slidesToShow).addClass("slick-active") : d.length <= b.options.slidesToShow ? d.addClass("slick-active") : (f = b.slideCount % b.options.slidesToShow, e = b.options.infinite === !0 ? b.options.slidesToShow + a : a, b.options.slidesToShow == b.options.slidesToScroll && b.slideCount - a < b.options.slidesToShow ? d.slice(e - (b.options.slidesToShow - f), e + f).addClass("slick-active") : d.slice(e, e + b.options.slidesToShow).addClass("slick-active")), "ondemand" === b.options.lazyLoad && b.lazyLoad();
    ...
    var b = this;a(".slick-cloned", b.$slider).remove(), b.$dots && b.$dots.remove(), b.$prevArrow && b.htmlExpr.test(b.options.prevArrow) && b.$prevArrow.remove(), b.$nextArrow && b.htmlExpr.test(b.options.nextArrow) && b.$nextArrow.remove(), b.$slides.removeClass("slick-slide slick-active slick-visible slick-current").css("width", "");
...
!function (a) {
  ...
  a.extend(a.fn, { validate: function validate(b) {
    ...
    }, messages: messageGenerator(a), autoCreateRanges: !1, prototype: { init: function init() {
        function b(b) {
...
function messageGenerator(a) {
  const lang = $('html').attr('lang') === "he-IL" ? 'he' : 'en';

  const translation = {
    required: lang === 'en' ? "This field is required." : 'זהו שדה חובה.',
    remote: lang === 'en' ? "Please fix this field." : 'אנא תקן את השדה הזה.',
    email: lang === 'en' ? "Please enter a valid email address." : 'אנא הזן כתובת דוא"ל תקנית.',
    url: lang === 'en' ? "Please enter a valid URL." : 'אנא הכנס כתובת תקינה.',
    date: lang === 'en' ? "Please enter a valid date." : 'נא להזין תאריך חוקי.',
    dateISO: lang === 'en' ? "Please enter a valid date (ISO)." : 'נא להזין תאריך חוקי (ISO).',
    number: lang === 'en' ? "Please enter a valid number." : 'נא הכנס מספר תקף.',
    digits: lang === 'en' ? "Please enter only digits." : 'בבקשה הכנס רק ספרות.',
    equalTo: lang === 'en' ? "Please enter the same value again." : 'נא להזין שוב את אותו הערך.',
    maxlength: lang === 'en' ? a.validator.format("Please enter no more than {0} characters.") : a.validator.format("אנא הזן לא יותר מ-{0} תווים."),
    minlength: lang === 'en' ? a.validator.format("Please enter at least {0} characters.") : a.validator.format("אנא הזן לפחות {0} תווים."),
    rangelength: lang === 'en' ? a.validator.format("Please enter a value between {0} and {1} characters long.") : a.validator.format("אנא הזן ערך באורך של בין {0} ל-{1} תווים."),
    range: lang === 'en' ? a.validator.format("Please enter a value between {0} and {1}.") : a.validator.format("אנא הזן ערך בין {0} ל-{1}."),
    max: lang === 'en' ? a.validator.format("Please enter a value less than or equal to {0}.") : a.validator.format("אנא הזן ערך הקטן או שווה ל-{0}."),
    min: lang === 'en' ? a.validator.format("Please enter a value greater than or equal to {0}.") : a.validator.format("אנא הזן ערך גדול או שווה ל-{0}."),
    step: lang === 'en' ? a.validator.format("Please enter a multiple of {0}.") : a.validator.format("אנא הזן כפולה של {0}.")
  }
